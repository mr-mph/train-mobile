          ...
          <InstallProgress
            ...
            idleDescription={
              <>
                ...
                <code className="px-1 py-0.5 rounded bg-black text-green-400">{packageName}</code>{" "}
                package (installed via{" "}
                <code className="px-1 py-0.5 rounded bg-black text-green-400">{installTarget}</code>),
